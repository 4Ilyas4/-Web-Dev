...
export class AppCComponent {
  ...
  categoryList: Category[] = [
    { id: 0, name: "acdc", productList: products.slice(0, 5) },
    { id: 1, name: "rhcp", productList: products.slice(5, 10) },
    { id: 2, name: "muse", productList: products.slice(10, 15) },
    { id: 3, name: "dm", productList: products.slice(15, 20) },
  ];
