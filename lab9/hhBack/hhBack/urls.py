...
urlpatterns = [
    ...
    path('api/vacancies/',views.VacancyListViewSet.as_view({'get': 'list', 'post': 'create'}), name='vacancy-list'), 
    path('api/vacancies/<int:id>/',views.VacancyDetailViewSet.as_view({'get': 'retrieve', 'put': 'update', 'delete': 'destroy'}), name='vacancy-details'), 
    path('api/vacancies/top_ten/',views.TopTenVacancyListViewSet.as_view({'get': 'list'}), name='top-ten-vacancy'),
]
